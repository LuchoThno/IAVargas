...
exports.IaLocalVargasPanel = void 0;
...
class IaLocalVargasPanel {
    ...
    static createOrShow(extensionUri, client) {
        ...
        // Crear nuevo panel
        currentPanel = vscode.window.createWebviewPanel('iaLocalVargas', 'IA Local Vargas', vscode.ViewColumn.One, {
            enableScripts: true,
     ...
     */
    static async handleAnalyze(code, language) {
        try {
            this.sendMessage({ type: 'loading', loading: true });
...
${result.suggestions.slice(0, 3).map(s => `- ${s}`).join('\n')}
     ...
     */
    static async handleExecute(code, language) {
        try {
            this.sendMessage({ type: 'loading', loading: true });
...
exports.IaLocalVargasPanel = IaLocalVargasPanel;
