...
/**
 * Acción para refactorizar código
 */
class RefactorAction : AnAction() {
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        if (!selectionModel.hasSelection()) {
            IaLocalVargasPlugin.showError(project, "Selecciona código para refactorizar")
            return
        }
        ...
        try {
            val api = getApi()
            val result = api.refactor(code, language)
            ...
            if (apply == Messages.YES) {
                ...
                IaLocalVargasPlugin.showInfo(project, "✅ Código refactorizado")
            }
